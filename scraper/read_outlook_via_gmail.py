...
def build_shift_huddle_plan(today: date, categorized: dict[str, list[dict]] | None = None) -> str:
    ...
    rotating_ideas = {
        0: ("Monday — Three Straight 100s. Protect the Streak and Clear the Board Before Noon.",
            "Open on the win, because it's real: **7/23 Dinner 100%, 7/31 Lunch 100%, 8/1 Dinner 100% — "
            "three perfect shops in a row**, and **August is sitting at 100.0%**. Brad's July note had us "
            "at the bottom of the district on shops; this is the answer. Tell the team, then tell them "
            "what protects it — the streak dies the first shift somebody decides the shopper isn't in "
            "today. Now the Monday reset. **Clear the CrunchTime stack** — as of Friday it was eight "
            "deep with **L-Rev stacked four days (8/3, 8/4, 8/5, 8/6)** plus **VO-Inv Performance "
            "Fdsvce**, **VO-Rec BOSS: Alpha – Ohio Valley** and **VO-Rec Performance Fdsvce**. Post the "
            "labor reviews and receive the vendor orders this morning; L-Rev stacking is the exact "
            "pattern that keeps getting flagged. **Enter the 7/17 deposit — $433.90 book cash has been "
            "open three weeks** and it still shows as an O/S short. Two open items that only we can "
            "close: **FoodLogiQ incident 26-19263 (Produce – Lettuce)** has now pinged us **seven "
            "times** — quantity affected plus photos, submit it today — and **hub ticket 9780** is "
            "waiting on a **photo of the milkshake cooler ID tag** before the right gasket can even be "
            "ordered. New tool everybody needs to know: the **Universal Service Desk launched Aug 6** — "
            "one number for POS, Verifone, kiosks, menu boards, Mood Media, ComplianceMate and network: "
            "**888-411-0083**, portal **FiveGuysHelp.Zendesk.com**. Post it by the office phone. "
            "Standing: CO2 under 25% → order now and confirm the 50 lb backup. Scams are still live — "
            "**no email, login, cash, or shipping address over the phone, ever.**"),
        1: ("Tuesday — The Shake Station Cost Us a Guest. Fix It at the Source Today.",
            "We have a live **L3 guest complaint, Case #5NZYD2**, and it is entirely preventable. A "
            "guest in the dining room on **Tue Aug 4 at 6:30 PM** wrote: *\"My milkshakes were terrible. "
            "The 2 banana ones had bad bananas in them and the chocolate one had way too much chocolate "
            "syrup in it. Couldn't drink any of them.\"* Three shakes, one ticket, all three wrong — "
            "that is a station problem, not a bad night. Brad handed it to Bobby personally to resolve "
            "and close. Today, at the station: **pull every banana that isn't shake-ready** — if you "
            "wouldn't eat it off the counter it does not go in a cup — and **re-drill the build: "
            "chocolate syrup is a measured pump, not a pour.** Same measured discipline on every mix-in; "
            "over-syruping is a guest complaint AND a food-cost leak in the same motion. The shake "
            "station has been talking to us for two weeks and we haven't listened: Jeff found a "
            "**milkshake topping container with debris on the BOH clean rack** on his 8/2 walk, the "
            "**Milkshake Pump Cleaning was MISSED on 7/29**, and the **cooler gasket (ticket 9780)** is "
            "still torn. Clean containers, pump cleaned on schedule, ID-tag photo sent. And sell it "
            "right while we fix it — **the Blackberry LTO ends Sunday Aug 16, this is the last week we "
            "have it.** Offer it out loud on every order, milkshake + drink + fries every ticket, Large "
            "soda 30¢ up. We're **#1 in Incidence Sales company-wide**; we hold that by asking, and we "
            "keep the guest by building it right."),
        2: ("Wednesday — Cheeseburger Is $3,374 Over Theoretical. Weigh the Patty, Cook to the Board.",
            "The money leak has a name and a number. Total **COGS variance is $6,998 over theoretical**, "
            "and the single biggest line is the **Cheeseburger: actual $4,366 against a theoretical "
            "$992 — $3,374 over by itself.** That is not rounding and it is not price; that is patty "
            "count, heavy rolls, and cooked meat going in the trash. Three things today at the grill: "
            "**spot-check the 3.5 oz patty roll** — weigh a few, correct anybody rolling heavy on the "
            "spot; **cook to the board, not to a guess**, so we're not dumping product at the end of a "
            "rush; **every waste item gets logged as it happens** — an unlogged throw-away is the "
            "variance nobody can explain at period close. Same discipline down the line: fries scooped "
            "to the line and not heaped, toppings measured, condiments portioned, lids on. Here is why "
            "it matters right now — the last closed week landed **COGS 22.0% + Labor 19.71% = 41.71% "
            "combined**, under Brad's **55% to Stay Alive** line by **13.29 points**, and that ties to "
            "the bonus. We are winning this and the food side is the half that can give it back. Sales "
            "are carrying hard (**week to date $17,516 vs $15,268 last year, +14.7%**, and Brad's Aug 6 "
            "note was *\"Excellent job resulting in +30% in Sales VS LY!\"*), but a strong top line only "
            "pays if the food cost holds underneath it. Tickets stay **under 6 minutes** while the grill "
            "runs tight — meat on before the order when 3+ are in line."),
        3: ("Thursday — Steritech Still Hasn't Hit Us. Jeff's Punch List Is the Practice Test.",
            "The inspector worked **1959 Lafayette on 7/27** and **1954 on 7/31** — two district stores "
            "in five days — and **2065 has not been hit yet.** Statistically we are the one still "
            "standing in the window. The good news is we already have the answer key: **Jeff Reiss's "
            "8/2 site visit punch list** reads exactly like a Steritech pre-check. Work it today, item "
            "by item: **expired product out of the walk-in** (he found an expired coffee bottle), "
            "**garbage cans on the line emptied — no liquid, no debris**, **ice bucket stored the right "
            "end up**, **mop sink clean**, **hood degreased above the grill**, **ketchup splatter off "
            "the wall by the sink**, **lobby and bathroom intake vents wiped**, **the cracked patty "
            "press reported**. Then the daily standard on top of it: wash and sanitize ALL produce, "
            "**test the veggie wash and log it**, sanitizer buckets changed on schedule, gloves changed "
            "between tasks, and the **manager walk before doors, signed** — hand sinks for handwashing "
            "ONLY, DayMark discard dates current, potato-cutter teeth and slicer blades chip-free (that "
            "was a CRITICAL at 1704), lids on mushrooms and onions, wet dishes stacked. **Time-and-temps "
            "logged ON TIME, never backfilled** — Thursday Aug 6 came back completely clean, every temp "
            "and checklist done; that is the standard now, not the exception. Restroom stays our "
            "systemic shop miss (two shops at -20 for dirty floor and dirty sink): named owner, hourly "
            "check, signed sheet, a real walk-in during dinner. August heat — log refrigeration temps "
            "and watch the coolers."),
        4: ("Friday — Shop Review: Three 100s and a Perfect August. Kasey Is the One Who Needs One.",
            "Pull the shop board and read it out loud, because it finally reads well. **7/23 Dinner "
            "100%, 7/31 Lunch 100%, 8/1 Dinner 100%** — three straight, **August is 100.0%**, and the "
            "store is **84.6% YTD across 44 shops**. Name the people who ran them: 7/23 was Bobby "
            "Cline, Francisco Llorente Mejias, Jeremiah Matthews, Madison Cureton, Richard Gibbs · 7/31 "
            "was Bobby Cline, Lidy Henry, Madison Cureton · 8/1 was Bobby Cline and Madison Cureton. "
            "**Madison managed all three.** Now the part that needs work — the manager board: **Nathan "
            "Roberts 94.8% YTD (6 shops), Vicki Lucey 86.5% (15), Madison Cureton 84.1% (30), and Kasey "
            "Wilson 75.1% (7) — the only one under 80%.** Kasey needs a shop and needs the basics "
            "coached in person, not over email. The points live where they always live: the **HALO "
            "EFFECT** — warm greet at the door AND the register, order called back at handoff, "
            "fries-up, a real thank-you and goodbye — plus **tickets under 6 minutes** (over 8 min = "
            "-5, over 10 = -20, fry station is the named bottleneck), **every bag checked against the "
            "ticket**, and the **milkshake offered out loud on every order.** Jeff's top three from his "
            "walk are shop points too: **open signs on before doors · greet every guest at the door "
            "after a shift change · no phones on the register.** Set the weekend crew up to make it "
            "four."),
        5: ("Saturday — Biggest Volume of the Week on a Thin Bench. Sell the Blackberry Before It's Gone.",
            "Saturday volume — full prep, par up bread and potatoes early. **The bench is thinner than "
            "it was a month ago (four terminations processed 7/29)**, so **cross-cover on purpose**: "
            "everybody knows their backup station before the rush, not during it, and nobody gets "
            "stranded on fries alone. Thin bench does **not** mean we stop cutting. Labor is our best "
            "story right now — **Thursday Aug 6 ran 14.53% on 1,012 guests and $5,349 in net sales**, "
            "week to date **20.10%**, all well under Brad's 25% ceiling. That day we **outsold every "
            "store in the DM1 district** (Lafayette $4,988, Muncie $3,593, Kokomo $3,440). Hold it the "
            "way we earned it: **check the number hourly**, trim openers and mids on a real lull, "
            "**never the close**, 30-minute breaks actually taken, employee meals rung in. Then sell "
            "into the traffic, because the clock is running: **the Blackberry LTO comes off tomorrow, "
            "Sunday Aug 16 — this is the last full sales day we have it.** Push it on every burger, add "
            "the drink and the fries, Large soda 30¢ up. Suggestive selling is not optional. Keep "
            "tickets **under 6 minutes** with your fastest fry person stationed at peak and pre-dropping "
            "into the rush, and **check every bag against the ticket before it's sealed** — three "
            "straight 100% shops are on the line. Steritech-clean all day. Count the drawer and **enter "
            "the deposit tonight** — 7/17 is still open at $433.90 and that is three weeks."),
        6: ("Sunday — Last Day of the Blackberry. Close the Week Clean and Hand Over a Monday-Ready Store.",
            "Two jobs today. **First, the Blackberry LTO ends TODAY (Aug 16)** — last shift to sell it, "
            "so offer it out loud on every single order and let the team go out on a high number. Check "
            "the runout so the shake station knows the moment mix comes off, and make sure nobody is "
            "still offering it Monday. **Second, close the week the way 8/6 closed the day: completely "
            "clean.** That Thursday every time-and-temp and every checklist came back done and signed, "
            "and it's the proof this is a discipline gap, not a capability gap. Make it the standard: "
            "**the closing manager does not leave until the Closing Checklist and every time-and-temp "
            "are complete and signed** — on time, not backfilled the next morning. If something "
            "genuinely can't be finished, it gets written down and handed to the opener, never skipped "
            "silently. Then the rest of the close: re-par what the weekend drained (bread, potatoes, "
            "condiments, cups), DayMark labels current, **Milkshake Pump Cleaning done** (it was missed "
            "7/29 and we now have a shake complaint on the books), waste sheet honest, drawer counted "
            "and the **deposit ENTERED**, **CT tasks closed the day they land** — L-Rev stacked four "
            "deep last week and that is on us. Recap the week for the team: sales **+14.7% over last "
            "year**, Brad's *\"Excellent job resulting in +30% in Sales VS LY!\"*, labor holding in the "
            "**14–22%** range, **41.71% combined against the 55% line**, and **three straight 100% "
            "shops.** That's a strong month. Full floor discipline through the last hour so it keeps "
            "going, and hand the openers a Monday-ready store."),
    }
    biweekly_themes = [
        ("Even Weeks — Audit-Ready Every Shift: Steritech Is In the District and Jeff Has Already Walked Us",
         "Two things point the same direction. **(1) Steritech is actively working our district** — the "
         "inspector hit **1959 Lafayette on 7/27** and **1954 on 7/31**, and **2065 has not been hit "
         "yet**, which means we are the one still in the window. **(2) Our new District Manager, Jeff "
         "Reiss** (effective 7/27 over 2079, **2065**, 1731, 1704), **already walked the store on 8/2** "
         "and left a punch list. He came from the store that led the country on Shops and Steritech, so "
         "the standard in his head is not theoretical. Treat his list as the practice test and clear it "
         "every shift: **expired product out of the walk-in**, **line garbage cans with no liquid or "
         "debris**, **ice bucket stored right end up**, **mop sink clean**, **hood degreased**, "
         "**ketchup splatter off the wall**, **lobby and restroom intake vents wiped**, **milkshake "
         "topping containers clean on the rack**, **cracked patty press reported**. On top of it, the "
         "daily standard: **manager walk completed and SIGNED before doors** — hand sinks for "
         "handwashing only, DayMark discard dates current, potato-cutter teeth and slicer blades "
         "chip-free (a CRITICAL at 1704), lids on mushrooms and onions, wet dishes stacked, sanitizer "
         "buckets changed on schedule, veggie wash tested and logged. **Time-and-temps on time, never "
         "backfilled** — Thursday 8/6 came back completely clean; that is the bar. **Restroom checked "
         "hourly with a signed sheet** — it is our systemic shop miss (two shops at -20 for dirty floor "
         "and dirty sink) and it's the first thing a guest and an inspector both notice. Ride the "
         "momentum while we do it: **three straight 100% shops (7/23, 7/31, 8/1)** and **August at "
         "100.0%** — protect the streak with HALO EFFECT on every guest, tickets **under 6 minutes**, "
         "**every bag checked against the ticket**, and Jeff's top three: **open signs on before doors, "
         "greet every guest at the door after a shift change, no phones on the register.** Two live "
         "items all week: **hub ticket 9780 needs the milkshake-cooler ID-tag photo from us**, and the "
         "**Universal Service Desk is now the single number for all in-store tech — 888-411-0083 / "
         "FiveGuysHelp.Zendesk.com.** Scams still live — nothing over the phone, ever."),
        ("Odd Weeks — Win the 55%: Defend the Labor Win, Kill the Cheeseburger Leak, Fix the Shake Station",
         "One directive frames the week — Brad's **\"55% to Stay Alive\"**: COGS + Labor combined must "
         "land **under 55%**, and it ties to the bonus. The last fully closed week came in at **41.71% "
         "(COGS 22.0% + Labor 19.71%) — under by 13.29 points.** Three things hold it. **(1) LABOR — we "
         "won it, now defend it.** **Thursday 8/6 ran 14.53% on 1,012 guests and $5,349 net**, week to "
         "date **20.10%** on 326.5 hours, month to date **20.62%** — all well under the 25% ceiling. "
         "Sales are up **+14.7% over last year** ($17,516 vs $15,268) and Brad's 8/6 note was "
         "*\"Excellent job resulting in +30% in Sales VS LY!\"*, so hours are affordable where the "
         "volume is — the discipline lives in the slow patches. Check the number hourly, trim openers "
         "and mids on a real lull, **never the close**, 30-minute breaks actually taken, employee meals "
         "rung in. Bench is thin after **four terminations on 7/29**, so cross-cover on purpose instead "
         "of overstaffing to feel safe. **(2) FOOD COST — the other half, and it has a name.** Total "
         "variance is **$6,998 over theoretical**, with **Cheeseburger alone $3,374 over** (actual "
         "$4,366 vs theoretical $992). Spot-check the **3.5 oz patty roll**, cook to the board instead "
         "of over-cooking into waste, scoop fries and toppings to spec, and **log every waste item.** "
         "**(3) THE SHAKE STATION — it is now costing us both ways.** L3 guest complaint **Case "
         "#5NZYD2** (8/4): bad bananas in two banana shakes, way too much chocolate syrup in the third. "
         "Pull every banana that isn't shake-ready, treat **chocolate syrup as a measured pump**, keep "
         "topping containers clean, and get **Milkshake Pump Cleaning** done on schedule (missed 7/29). "
         "Over-syruping is a complaint and a food-cost leak in the same motion. Suggestive selling stays "
         "non-negotiable underneath all three — milkshake, drink, fries every ticket, **#1 in Incidence "
         "Sales company-wide** (**Blackberry LTO ends Sun Aug 16**, Large soda 30¢ up). Standing checks "
         "that keep biting us: **CO2 daily** (order under 25%, confirm the 50 lb backup), **close CT "
         "tasks the day they land** (L-Rev stacked four deep last week — 8/3 through 8/6), **the 7/17 "
         "deposit entered** ($433.90, open three weeks), **FoodLogiQ 26-19263 submitted** (seven "
         "reminders), the **Closing Checklist signed before the closing manager leaves**, and the "
         "**ID-tag photo to hub ticket 9780.** New: **Universal Service Desk — 888-411-0083 / "
         "FiveGuysHelp.Zendesk.com** for all in-store tech. Open from Brad: **Incident Process PDRs** "
         "for the entire Shift Lead team. Scams still live — nothing over the phone, ever."),
    ]
