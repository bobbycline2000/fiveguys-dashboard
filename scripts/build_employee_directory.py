...
EMPLOYEES = [
    ...
    ("Justice",   "(PHONE PENDING)", "Active"),
    ("Kable",     "(502) 606-3088", "Active"),
    ("Kaisha",    "(502) 439-9802", "Active"),
